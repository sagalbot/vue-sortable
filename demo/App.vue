...
Vue.use(Sortable)</code></pre>
          ...
          <div class="row">
            <div class="col-md-4">
              <p>If you need to access the sortable instance itself, you can do so by providing an identifier argument to the directive with the
                <code>:</code> syntax.</p>
              <p>In this example, you could access the sortable instance from within your vm via
                <code>this.sortable.list</code>.</p>
            </div>
...
&#x3C;/ul&#x3E;</code></pre>
      ...
      <div class="row">
        <div class="col-md-8 col-md-offset-2">
          <h1 class="page-header">Use as a Component</h1>
    ...
    <footer>
      <div class="container text-center">
        <small>Free to Use Under The MIT License (MIT) | Created by
          <a href="http://github.com/sagalbot">@sagalbot</a></small>
      </div>
    </footer>
  </div>
</template>
...
<script>
  ...
  import DataExample from './Data.vue'

  export default {
    components: {Basic, Custom, DataExample}
  }
</script>